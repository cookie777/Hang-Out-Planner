...
var userCurrentLocation : Location = Location(
  ...
  apiId: nil,
  category: .other,
  latitude: (UserLocationController.shared.coordinatesMostRecent?.latitude ?? 0) as Double,
  longitude: (UserLocationController.shared.coordinatesMostRecent?.longitude ?? 0) as Double,
  title: "Start",
  imageURL: nil,
  address: "",
  website: nil,
