...
struct Location{
  ...
  static var sampleLocations = [
    ...
    Location(id: "2", category: .park, longitude: 49.304258, latitude: -123.144252, title: "Stanley Park", imageURL: nil, address: "1166 Stanley Park Drive Vancouver, BC V6G", website: nil, rating: 4.7),
  ]
